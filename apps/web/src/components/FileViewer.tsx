        ...
        {source === null ? (
          ...
          >
            ...
            {/* RACCOONUI-PATCH: warn the user when comment selection is on
                ...
                contract without round-tripping through the LLM. Triggers
                under both legacy boardMode and upstream's new
                drawClickSelectionMode (PR #1276/#1435). — 2026-05-08 */}
            {(boardMode || drawClickSelectionMode) && boardTargetsReported && liveCommentTargets.size === 0 ? (
