...
//
// Renders the full manifest-driven inspector (example query, inputs
// schema, resolved context bundles, workflow stages, GenUI surfaces,
// connectors, capabilities, declared example outputs, source
// provenance). Used by the home gallery's `PluginDetailsModal`
// dispatcher whenever the plugin does not ship a richer preview
// (image/video/HTML/design-system tile). Apply still routes through
// the same `usePlugin` flow the home card uses.
