...
export const it: Dict = {
  ...
  // RACCOONUI-PATCH: fork keys (per-project git + retag-anchors) re-injected on upstream sync
  'projectGit.busyCommit': 'Commit in corso…',
  'projectGit.busyCreateRemote': 'Creazione repo GitHub…',
  'projectGit.busyImportFs': 'Sincronizzazione…',
  'projectGit.busyInit': 'Inizializzazione…',
  'projectGit.busyPush': 'Push in corso…',
  'projectGit.busyRollback': 'Revert in corso…',
  'projectGit.commitBtn': 'Commit',
  'projectGit.commitDone': 'Commit {hash}',
  'projectGit.commitLabel': 'Messaggio di commit',
  'projectGit.commitNothing': 'Niente da committare.',
  'projectGit.commitPlaceholder': 'Descrivi cosa hai cambiato…',
  'projectGit.createRemoteBtn': 'Crea repo GitHub e fai push',
  'projectGit.createRemoteDone': 'Creato e pushato: {url}',
  'projectGit.createRemoteExisted': 'Il repo esisteva già; pushato su {url}',
  'projectGit.createRemoteSubtitle': 'Crea un repo chiamato "{slug}" sotto il tuo account autenticato con gh e ci pusha il progetto.',
  'projectGit.createRemoteTitle': 'Pubblica su GitHub',
  'projectGit.errCommit': 'Commit fallito.',
  'projectGit.errCreateRemote': 'Creazione remote fallita: {detail}',
  'projectGit.errGhNotAuthed': 'gh CLI non autenticato. In un terminale esegui:',
  'projectGit.errGhNotInstalled': 'gh CLI non trovato su questa macchina. Installalo da:',
  'projectGit.errHistory': 'Impossibile caricare la cronologia.',
  'projectGit.errImportFs': 'Sincronizzazione fallita.',
  'projectGit.errInit': 'Init fallito.',
  'projectGit.errPush': 'Push fallito. Controlla il log del daemon per i dettagli.',
  'projectGit.errRollback': 'Revert fallito.',
  'projectGit.historyEmpty': 'Nessun commit ancora.',
  'projectGit.historyRevert': 'Revert',
  'projectGit.historyTitle': 'Cronologia',
  'projectGit.importFsBtn': 'Sincronizza dal filesystem',
  'projectGit.importFsBtnHint': 'Recupera i progetti scaricati con git ma non ancora presenti nel DB locale.',
  'projectGit.importFsDone': 'Importati {count} progetto/i.',
  'projectGit.initBtn': 'Inizializza repo',
  'projectGit.noProject': 'Apri un progetto per eseguire operazioni git su di esso.',
  'projectGit.pushBtn': 'Push',
  'projectGit.pushDone': 'Push effettuato su {remote}/{branch}',
  'projectGit.pushNoRemoteHint': 'Aggiungi prima un remote (usa lo script git-init-project per fare il bootstrap di un repo GitHub).',
  'projectGit.rollbackConfirm': 'Revert del commit {hash}? Verrà aggiunto un commit inverso in cima.',
  'projectGit.rollbackDone': 'Revert eseguito.',
  'projectGit.statusBranch': 'Branch',
  'projectGit.statusClean': 'Working tree pulito',
  'projectGit.statusDirty': '{count} modifica/e',
  'projectGit.statusHasRemote': 'Remote configurato',
  'projectGit.statusNoRemote': 'Nessun remote configurato',
  'projectGit.subtitle': 'Init, commit, push e rollback di questo progetto. Ogni progetto vive nel proprio repo GitHub.',
  'projectGit.title': 'Git del progetto',
  'projectGit.uninitialized': 'Questo progetto non è ancora inizializzato come repo git.',
  'projectGit.visibilityLabel': 'Visibilità del repo',
  'projectGit.visibilityPrivate': 'Privato',
  'projectGit.visibilityPublic': 'Pubblico',
  // RACCOONUI-PATCH: backfill missing fork keys (en fallback) on upstream sync — 2026-06-12
  'settings.projectGit': 'Project Git',
  'settings.projectGitHint': 'Sync project to GitHub',
  'newproj.slugLabel': 'Project ID (slug)',
  'newproj.slugPlaceholder': 'optional · used as git repo name',
  'newproj.slugHint': 'GitHub repo will be: {repo}',
  'newproj.slugInvalid': 'Slug must match [A-Za-z0-9._-] (1–128 chars)',
  ...
  'fileViewer.tweaksRetagBtn': 'Add anchors from id attributes',
  'fileViewer.tweaksRetagBusy': 'Adding anchors…',
  'fileViewer.tweaksRetagDone': 'Tagged {count} elements.',
  'fileViewer.tweaksRetagNoop': 'No structural elements with an id were found. Add id="..." to your <section> tags first.',
  'fileViewer.tweaksRetagFailed': 'Could not add anchors: {detail}',
};
