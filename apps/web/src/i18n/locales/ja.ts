...
export const ja: Dict = {
  ...
  'settings.projectGit': 'プロジェクト Git',
  'settings.projectGitHint': 'プロジェクトを GitHub に同期',
  ...
  'newproj.slugLabel': 'プロジェクト ID (slug)',
  'newproj.slugPlaceholder': '省略可 · git リポジトリ名として使われます',
  'newproj.slugHint': 'GitHub リポジトリ名: {repo}',
  'newproj.slugInvalid': 'Slug は [A-Za-z0-9._-] にマッチする必要があります（1–128 文字）',
  ...
  'projectGit.title': 'プロジェクト Git',
  'projectGit.subtitle': 'このプロジェクトを init / commit / push / rollback します。各プロジェクトは独立した GitHub リポジトリに対応します。',
  'projectGit.noProject': 'まずプロジェクトを開いてから git 操作を行ってください。',
  'projectGit.uninitialized': 'このプロジェクトはまだ git リポジトリとして初期化されていません。',
  'projectGit.initBtn': 'リポジトリを初期化',
  'projectGit.importFsBtn': 'ファイルシステムから同期',
  'projectGit.importFsBtnHint': 'git で pull したがローカル DB にまだ無いプロジェクトを取り込みます。',
  'projectGit.importFsDone': '{count} 個のプロジェクトを取り込みました。',
  'projectGit.statusBranch': 'ブランチ',
  'projectGit.statusClean': 'ワーキングツリーはクリーン',
  'projectGit.statusDirty': '{count} 件の変更',
  'projectGit.statusNoRemote': 'remote 未設定',
  'projectGit.statusHasRemote': 'remote 設定済み',
  'projectGit.commitLabel': 'コミットメッセージ',
  'projectGit.commitPlaceholder': '変更内容を記述…',
  'projectGit.commitBtn': 'コミット',
  'projectGit.commitNothing': 'コミットする変更がありません。',
  'projectGit.commitDone': '{hash} をコミットしました',
  'projectGit.pushBtn': 'プッシュ',
  'projectGit.pushDone': '{remote}/{branch} にプッシュしました',
  'projectGit.pushNoRemoteHint': 'まず remote を追加してください（git-init-project ヘルパースクリプトで GitHub リポジトリを作成）。',
  'projectGit.historyTitle': '履歴',
  'projectGit.historyEmpty': 'まだコミットがありません。',
  'projectGit.historyRevert': 'Revert',
  'projectGit.rollbackConfirm': 'コミット {hash} を Revert しますか？逆コミットを上に追加します。',
  'projectGit.rollbackDone': 'Revert しました。',
  'projectGit.busyInit': '初期化中…',
  'projectGit.busyCommit': 'コミット中…',
  'projectGit.busyPush': 'プッシュ中…',
  'projectGit.busyImportFs': '同期中…',
  'projectGit.busyRollback': 'Revert 中…',
  'projectGit.busyCreateRemote': 'GitHub repo を作成中…',
  'projectGit.createRemoteTitle': 'GitHub に公開',
  'projectGit.createRemoteSubtitle': 'gh で認証中のアカウントに「{slug}」という repo を作成して、プロジェクトをそこに push します。',
  'projectGit.createRemoteBtn': 'GitHub repo を作成して push',
  'projectGit.createRemoteDone': '作成して push しました：{url}',
  'projectGit.createRemoteExisted': 'Repo はすでに存在します。push しました：{url}',
  'projectGit.visibilityLabel': 'Repo の公開範囲',
  'projectGit.visibilityPrivate': 'Private',
  'projectGit.visibilityPublic': 'Public',
  'projectGit.errInit': '初期化に失敗しました。',
  'projectGit.errCommit': 'コミットに失敗しました。',
  'projectGit.errPush': 'プッシュに失敗しました。詳細は daemon ログを確認してください。',
  'projectGit.errHistory': '履歴を読み込めませんでした。',
  'projectGit.errRollback': 'Revert に失敗しました。',
  'projectGit.errImportFs': '同期に失敗しました。',
  'projectGit.errCreateRemote': 'remote の作成に失敗しました：{detail}',
  'projectGit.errGhNotInstalled': 'このマシンに gh CLI が見つかりません。こちらからインストール：',
  'projectGit.errGhNotAuthed': 'gh CLI が未認証です。ターミナルで実行：',
};
