...
export const ko: Dict = {
  ...
  'settings.projectGit': '프로젝트 Git',
  'settings.projectGitHint': '프로젝트를 GitHub에 동기화',
  ...
  'newproj.slugLabel': '프로젝트 ID (slug)',
  'newproj.slugPlaceholder': '선택 사항 · git 리포지토리 이름으로 사용됨',
  'newproj.slugHint': 'GitHub 리포지토리: {repo}',
  'newproj.slugInvalid': 'Slug는 [A-Za-z0-9._-] 형식이어야 합니다 (1–128자)',
  ...
  'projectGit.title': '프로젝트 Git',
  'projectGit.subtitle': '이 프로젝트의 init, commit, push, rollback을 실행합니다. 각 프로젝트는 독립된 GitHub 리포지토리에 대응합니다.',
  'projectGit.noProject': '먼저 프로젝트를 열고 git 작업을 진행하세요.',
  'projectGit.uninitialized': '이 프로젝트는 아직 git 리포지토리로 초기화되지 않았습니다.',
  'projectGit.initBtn': '리포지토리 초기화',
  'projectGit.importFsBtn': '파일 시스템에서 동기화',
  'projectGit.importFsBtnHint': 'git으로 받았지만 로컬 DB에 아직 없는 프로젝트를 가져옵니다.',
  'projectGit.importFsDone': '{count}개의 프로젝트를 가져왔습니다.',
  'projectGit.statusBranch': '브랜치',
  'projectGit.statusClean': '작업 트리가 깨끗함',
  'projectGit.statusDirty': '{count}개의 변경 사항',
  'projectGit.statusNoRemote': 'remote가 설정되지 않음',
  'projectGit.statusHasRemote': 'remote가 설정됨',
  'projectGit.commitLabel': '커밋 메시지',
  'projectGit.commitPlaceholder': '변경 내용을 설명…',
  'projectGit.commitBtn': '커밋',
  'projectGit.commitNothing': '커밋할 변경 사항이 없습니다.',
  'projectGit.commitDone': '{hash} 커밋됨',
  'projectGit.pushBtn': '푸시',
  'projectGit.pushDone': '{remote}/{branch}에 푸시됨',
  'projectGit.pushNoRemoteHint': '먼저 remote를 추가하세요 (git-init-project 헬퍼 스크립트로 GitHub 리포지토리 생성).',
  'projectGit.historyTitle': '히스토리',
  'projectGit.historyEmpty': '아직 커밋이 없습니다.',
  'projectGit.historyRevert': 'Revert',
  'projectGit.rollbackConfirm': '커밋 {hash}을(를) Revert 할까요? 위에 역방향 커밋이 추가됩니다.',
  'projectGit.rollbackDone': 'Revert 했습니다.',
  'projectGit.busyInit': '초기화 중…',
  'projectGit.busyCommit': '커밋 중…',
  'projectGit.busyPush': '푸시 중…',
  'projectGit.busyImportFs': '동기화 중…',
  'projectGit.busyRollback': 'Revert 중…',
  'projectGit.busyCreateRemote': 'GitHub repo 생성 중…',
  'projectGit.createRemoteTitle': 'GitHub에 게시',
  'projectGit.createRemoteSubtitle': 'gh로 인증된 계정 아래에 "{slug}" repo를 만들고 프로젝트를 push합니다.',
  'projectGit.createRemoteBtn': 'GitHub repo 생성 및 push',
  'projectGit.createRemoteDone': '생성 및 push 완료: {url}',
  'projectGit.createRemoteExisted': 'Repo가 이미 존재합니다. push 완료: {url}',
  'projectGit.visibilityLabel': 'Repo 공개 범위',
  'projectGit.visibilityPrivate': 'Private',
  'projectGit.visibilityPublic': 'Public',
  'projectGit.errInit': '초기화에 실패했습니다.',
  'projectGit.errCommit': '커밋에 실패했습니다.',
  'projectGit.errPush': '푸시에 실패했습니다. 자세한 내용은 daemon 로그를 확인하세요.',
  'projectGit.errHistory': '히스토리를 불러올 수 없습니다.',
  'projectGit.errRollback': 'Revert에 실패했습니다.',
  'projectGit.errImportFs': '동기화에 실패했습니다.',
  'projectGit.errCreateRemote': 'remote 생성 실패: {detail}',
  'projectGit.errGhNotInstalled': '이 컴퓨터에서 gh CLI를 찾을 수 없습니다. 설치 페이지:',
  'projectGit.errGhNotAuthed': 'gh CLI가 인증되지 않았습니다. 터미널에서 실행:',
};
