...
export const th: Dict = {
  ...
  'projectGit.busyCommit': 'Committing…',
  'projectGit.busyCreateRemote': 'Creating GitHub repo…',
  'projectGit.busyImportFs': 'Syncing…',
  'projectGit.busyInit': 'Initializing…',
  'projectGit.busyPush': 'Pushing…',
  'projectGit.busyRollback': 'Reverting…',
  'projectGit.commitBtn': 'Commit',
  'projectGit.commitDone': 'Committed {hash}',
  'projectGit.commitLabel': 'Commit message',
  'projectGit.commitNothing': 'Nothing to commit.',
  'projectGit.commitPlaceholder': 'Describe what you changed…',
  'projectGit.createRemoteBtn': 'Create GitHub repo & push',
  'projectGit.createRemoteDone': 'Created and pushed: {url}',
  'projectGit.createRemoteExisted': 'Repo already existed; pushed to {url}',
  'projectGit.createRemoteSubtitle': 'Creates a repo named "{slug}" under your gh-authenticated account and pushes the project there.',
  'projectGit.createRemoteTitle': 'Publish to GitHub',
  'projectGit.errCommit': 'Commit failed.',
  'projectGit.errCreateRemote': 'Create remote failed: {detail}',
  'projectGit.errGhNotAuthed': 'gh CLI not authenticated. In a terminal run:',
  'projectGit.errGhNotInstalled': 'gh CLI not found on this machine. Install it from:',
  'projectGit.errHistory': 'Could not load history.',
  'projectGit.errImportFs': 'Sync failed.',
  'projectGit.errInit': 'Init failed.',
  'projectGit.errPush': 'Push failed. Check the daemon log for details.',
  'projectGit.errRollback': 'Revert failed.',
  'projectGit.historyEmpty': 'No commits yet.',
  'projectGit.historyRevert': 'Revert',
  'projectGit.historyTitle': 'History',
  'projectGit.importFsBtn': 'Sync from filesystem',
  'projectGit.importFsBtnHint': 'Pick up projects pulled in via git but not yet in the local DB.',
  'projectGit.importFsDone': 'Imported {count} project(s).',
  'projectGit.initBtn': 'Init repo',
  'projectGit.noProject': 'Open a project to use git operations on it.',
  'projectGit.pushBtn': 'Push',
  'projectGit.pushDone': 'Pushed to {remote}/{branch}',
  'projectGit.pushNoRemoteHint': 'Add a remote first (use the helper script git-init-project to bootstrap a GitHub repo).',
  'projectGit.rollbackConfirm': 'Revert commit {hash}? This adds an inverse commit on top.',
  'projectGit.rollbackDone': 'Reverted.',
  'projectGit.statusBranch': 'Branch',
  'projectGit.statusClean': 'Working tree clean',
  'projectGit.statusDirty': '{count} change(s)',
  'projectGit.statusHasRemote': 'Remote configured',
  'projectGit.statusNoRemote': 'No remote configured',
  'projectGit.subtitle': 'Init, commit, push, and roll back this project. Each project lives in its own GitHub repo.',
  'projectGit.title': 'Project Git',
  'projectGit.uninitialized': 'This project is not initialized as a git repo yet.',
  'projectGit.visibilityLabel': 'Repo visibility',
  'projectGit.visibilityPrivate': 'Private',
  'projectGit.visibilityPublic': 'Public',
