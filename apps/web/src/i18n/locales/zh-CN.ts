...
export const zhCN: Dict = {
  ...
  'settings.projectGit': '项目 Git',
  'settings.projectGitHint': '同步专案到 GitHub',
  ...
  'newproj.slugLabel': '项目 ID (slug)',
  'newproj.slugPlaceholder': '可选 · 用作 git 仓库名',
  'newproj.slugHint': 'GitHub 仓库将是：{repo}',
  'newproj.slugInvalid': 'Slug 必须匹配 [A-Za-z0-9._-]（1–128 字符）',
  ...
  'fileViewer.tweaksUntaggedTitle': '这份文件没有被 Tweaks 标记',
  'fileViewer.tweaksUntaggedHint': 'Picker / Pods 需要每个 <section> 都带 data-od-id。修 skill 或重新生成来补上锚点。',
  'fileViewer.tweaksRetagBtn': '从 id 属性自动加上锚点',
  'fileViewer.tweaksRetagBusy': '正在加锚点…',
  'fileViewer.tweaksRetagDone': '已标记 {count} 个 element',
  'fileViewer.tweaksRetagNoop': '找不到带 id 的结构元素,先在 <section> 加 id="..." 再试一次',
  'fileViewer.tweaksRetagFailed': '加锚点失败:{detail}',
  ...
  'projectGit.title': '项目 Git',
  'projectGit.subtitle': '为当前项目执行 init、commit、push、rollback。每个项目对应独立的 GitHub 仓库。',
  'projectGit.noProject': '请先开启一个项目，再对其执行 git 操作。',
  'projectGit.uninitialized': '此项目尚未初始化为 git 仓库。',
  'projectGit.initBtn': '初始化仓库',
  'projectGit.importFsBtn': '从档案系统同步',
  'projectGit.importFsBtnHint': '抓取以 git 拉到的、但还没在本机 DB 的专案。',
  'projectGit.importFsDone': '已导入 {count} 个专案。',
  'projectGit.statusBranch': '分支',
  'projectGit.statusClean': '工作目录干净',
  'projectGit.statusDirty': '{count} 项变更',
  'projectGit.statusNoRemote': '未配置 remote',
  'projectGit.statusHasRemote': '已配置 remote',
  'projectGit.commitLabel': '提交讯息',
  'projectGit.commitPlaceholder': '描述这次变更…',
  'projectGit.commitBtn': '提交',
  'projectGit.commitNothing': '没有可提交的变更。',
  'projectGit.commitDone': '已提交 {hash}',
  'projectGit.pushBtn': '推送',
  'projectGit.pushDone': '已推送到 {remote}/{branch}',
  'projectGit.pushNoRemoteHint': '请先配置 remote（使用 git-init-project helper 脚本建立 GitHub repo）。',
  'projectGit.historyTitle': '历史',
  'projectGit.historyEmpty': '还没有提交。',
  'projectGit.historyRevert': '撤销',
  'projectGit.rollbackConfirm': '是否撤销提交 {hash}？将在其上加上一个反向提交。',
  'projectGit.rollbackDone': '已撤销。',
  'projectGit.busyInit': '初始化中…',
  'projectGit.busyCommit': '提交中…',
  'projectGit.busyPush': '推送中…',
  'projectGit.busyImportFs': '同步中…',
  'projectGit.busyRollback': '撤销中…',
  'projectGit.busyCreateRemote': '创建 GitHub repo 中…',
  'projectGit.createRemoteTitle': '发布到 GitHub',
  'projectGit.createRemoteSubtitle': '在你 gh 已登录的账户下创建名为「{slug}」的 repo，并把项目推送上去。',
  'projectGit.createRemoteBtn': '创建 GitHub repo 并推送',
  'projectGit.createRemoteDone': '已创建并推送：{url}',
  'projectGit.createRemoteExisted': 'Repo 已存在，已推送到：{url}',
  'projectGit.visibilityLabel': 'Repo 可见性',
  'projectGit.visibilityPrivate': '私有',
  'projectGit.visibilityPublic': '公开',
  'projectGit.errInit': '初始化失败。',
  'projectGit.errCommit': '提交失败。',
  'projectGit.errPush': '推送失败。详见 daemon 日志。',
  'projectGit.errHistory': '无法载入历史。',
  'projectGit.errRollback': '撤销失败。',
  'projectGit.errImportFs': '同步失败。',
  'projectGit.errCreateRemote': '创建 remote 失败：{detail}',
  'projectGit.errGhNotInstalled': '本机未找到 gh CLI。请从这里安装：',
  'projectGit.errGhNotAuthed': 'gh CLI 尚未登录。请在终端运行：',
