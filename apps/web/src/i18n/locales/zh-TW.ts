...
export const zhTW: Dict = {
  ...
  'fileViewer.tweaksRetagBtn': '從 id 屬性自動加上錨點',
  'fileViewer.tweaksRetagBusy': '正在加錨點…',
  'fileViewer.tweaksRetagDone': '已標記 {count} 個 element',
  'fileViewer.tweaksRetagFailed': '加錨點失敗:{detail}',
  'fileViewer.tweaksRetagNoop': '找不到帶 id 的結構元素,先在 <section> 加 id="..." 再試一次',
  ...
  'newproj.slugHint': 'GitHub repo 將是：{repo}',
  'newproj.slugInvalid': 'Slug 必須符合 [A-Za-z0-9._-]（1–128 字元）',
  'newproj.slugLabel': '專案 ID (slug)',
  'newproj.slugPlaceholder': '可選 · 用作 git repo 名',
  'projectGit.busyCommit': '提交中…',
  'projectGit.busyCreateRemote': '建立 GitHub repo 中…',
  'projectGit.busyImportFs': '同步中…',
  'projectGit.busyInit': '初始化中…',
  'projectGit.busyPush': '推送中…',
  'projectGit.busyRollback': '還原中…',
  'projectGit.commitBtn': '提交',
  'projectGit.commitDone': '已提交 {hash}',
  'projectGit.commitLabel': '提交訊息',
  'projectGit.commitNothing': '沒有可提交的變更。',
  'projectGit.commitPlaceholder': '描述這次變更…',
  'projectGit.createRemoteBtn': '建立 GitHub repo 並推送',
  'projectGit.createRemoteDone': '已建立並推送：{url}',
  'projectGit.createRemoteExisted': 'Repo 已存在，已推送到：{url}',
  'projectGit.createRemoteSubtitle': '在你 gh 已登入的帳號下建立名為「{slug}」的 repo，並把專案推上去。',
  'projectGit.createRemoteTitle': '發布到 GitHub',
  'projectGit.errCommit': '提交失敗。',
  'projectGit.errCreateRemote': '建立 remote 失敗：{detail}',
  'projectGit.errGhNotAuthed': 'gh CLI 尚未登入。請在終端機執行：',
  'projectGit.errGhNotInstalled': '本機找不到 gh CLI。請從這裡安裝：',
  'projectGit.errHistory': '無法載入歷史。',
  'projectGit.errImportFs': '同步失敗。',
  'projectGit.errInit': '初始化失敗。',
  'projectGit.errPush': '推送失敗。詳見 daemon 日誌。',
  'projectGit.errRollback': '還原失敗。',
  'projectGit.historyEmpty': '還沒有提交。',
  'projectGit.historyRevert': '還原',
  'projectGit.historyTitle': '歷史',
  'projectGit.importFsBtn': '從檔案系統同步',
  'projectGit.importFsBtnHint': '抓取以 git 拉到的、但還沒在本機 DB 的專案。',
  'projectGit.importFsDone': '已匯入 {count} 個專案。',
  'projectGit.initBtn': '初始化 repo',
  'projectGit.noProject': '請先開啟一個專案，再對其執行 git 操作。',
  'projectGit.pushBtn': '推送',
  'projectGit.pushDone': '已推送到 {remote}/{branch}',
  'projectGit.pushNoRemoteHint': '請先配置 remote（使用 git-init-project helper 腳本建立 GitHub repo）。',
  'projectGit.rollbackConfirm': '是否還原提交 {hash}？將在其上加上一個反向提交。',
  'projectGit.rollbackDone': '已還原。',
  'projectGit.statusBranch': '分支',
  'projectGit.statusClean': '工作目錄乾淨',
  'projectGit.statusDirty': '{count} 項變更',
  'projectGit.statusHasRemote': '已配置 remote',
  'projectGit.statusNoRemote': '未配置 remote',
  'projectGit.subtitle': '為目前專案執行 init、commit、push、rollback。每個專案對應獨立的 GitHub repo。',
  'projectGit.title': '專案 Git',
  'projectGit.uninitialized': '此專案尚未初始化為 git repo。',
  'projectGit.visibilityLabel': 'Repo 可見性',
  'projectGit.visibilityPrivate': '私有',
  'projectGit.visibilityPublic': '公開',
  'settings.projectGit': '專案 Git',
  'settings.projectGitHint': '同步專案到 GitHub',
};
