...
export interface Dict {
  ...
  'settings.projectGit': string;
  'settings.projectGitHint': string;
  ...
  // Per-project git workflow section
  'projectGit.title': string;
  'projectGit.subtitle': string;
  'projectGit.noProject': string;
  'projectGit.uninitialized': string;
  'projectGit.initBtn': string;
  'projectGit.importFsBtn': string;
  'projectGit.importFsBtnHint': string;
  'projectGit.importFsDone': string;
  'projectGit.statusBranch': string;
  'projectGit.statusClean': string;
  'projectGit.statusDirty': string;
  'projectGit.statusNoRemote': string;
  'projectGit.statusHasRemote': string;
  'projectGit.commitLabel': string;
  'projectGit.commitPlaceholder': string;
  'projectGit.commitBtn': string;
  'projectGit.commitNothing': string;
  'projectGit.commitDone': string;
  'projectGit.pushBtn': string;
  'projectGit.pushDone': string;
  'projectGit.pushNoRemoteHint': string;
  'projectGit.historyTitle': string;
  'projectGit.historyEmpty': string;
  'projectGit.historyRevert': string;
  'projectGit.rollbackConfirm': string;
  'projectGit.rollbackDone': string;
  'projectGit.busyInit': string;
  'projectGit.busyCommit': string;
  'projectGit.busyPush': string;
  'projectGit.busyImportFs': string;
  'projectGit.busyRollback': string;
  'projectGit.busyCreateRemote': string;
  'projectGit.createRemoteTitle': string;
  'projectGit.createRemoteSubtitle': string;
  'projectGit.createRemoteBtn': string;
  'projectGit.createRemoteDone': string;
  'projectGit.createRemoteExisted': string;
  'projectGit.visibilityLabel': string;
  'projectGit.visibilityPrivate': string;
  'projectGit.visibilityPublic': string;
  'projectGit.errInit': string;
  'projectGit.errCommit': string;
  'projectGit.errPush': string;
  'projectGit.errHistory': string;
  'projectGit.errRollback': string;
  'projectGit.errImportFs': string;
  'projectGit.errCreateRemote': string;
  'projectGit.errGhNotInstalled': string;
  'projectGit.errGhNotAuthed': string;
  ...
  'newproj.slugLabel': string;
  'newproj.slugPlaceholder': string;
  'newproj.slugHint': string;
  'newproj.slugInvalid': string;
